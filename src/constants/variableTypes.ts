...
/**
 * Collection variable types (enumerable — rendered as list)
 */
class CollectionVariableType {
    public static readonly genericList = "System.Collections.Generic.List";
    public static readonly hashSet = "System.Collections.Generic.HashSet";
    public static readonly queue = "System.Collections.Generic.Queue";
    public static readonly stack = "System.Collections.Generic.Stack";
    public static readonly linkedList = "System.Collections.Generic.LinkedList";
    public static readonly sortedSet = "System.Collections.Generic.SortedSet";
    public static readonly arrayList = "System.Collections.ArrayList";

    public static get typeSubstrings(): string[] {
        return [
            CollectionVariableType.genericList,
            CollectionVariableType.hashSet,
            CollectionVariableType.queue,
            CollectionVariableType.stack,
            CollectionVariableType.linkedList,
            CollectionVariableType.sortedSet,
            CollectionVariableType.arrayList
        ];
    }
}

/**
 * Key-value collection types (rendered as 2-column table)
 */
class KeyValueVariableType {
    public static readonly dictionary = "System.Collections.Generic.Dictionary";
    public static readonly sortedDictionary = "System.Collections.Generic.SortedDictionary";
    public static readonly sortedList = "System.Collections.Generic.SortedList";
    public static readonly hashtable = "System.Collections.Hashtable";

    public static get typeSubstrings(): string[] {
        return [
            KeyValueVariableType.dictionary,
            KeyValueVariableType.sortedDictionary,
            KeyValueVariableType.sortedList,
            KeyValueVariableType.hashtable
        ];
    }
}
 ...
 */
class DataSetVariableType {
    public static readonly dataSet = "System.Data.DataSet";
    public static readonly dataView = "System.Data.DataView";
}

/**
 * Tuple variable types
 */
class TupleVariableType {
    public static readonly tuple = "System.Tuple";
    public static readonly valueTuple = "System.ValueTuple";
}
